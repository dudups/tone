...
class CardTrendParser {
    Map parse(Aggregations aggs) {
        ...
        for (int i = 0; i < filters.size(); i++) {
            ...
            def cardTypeTerms = notEndFilter.aggregations[0] as ParsedStringTerms
            def cardTypeNotEndCount = cardTypeTerms.buckets.collectEntries {
            ...
            data[dateFilter.name] = [
                    ...
                    cardTypeNotEndCount: cardTypeNotEndCount,
            ]
        }
        data
    }
