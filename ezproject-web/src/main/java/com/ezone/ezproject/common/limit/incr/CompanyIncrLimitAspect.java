...
@Slf4j
@AllArgsConstructor
public class CompanyIncrLimitAspect {
    ...
    @Pointcut("@annotation(com.ezone.ezproject.common.limit.incr.CompanyIncrLimit)")
    public void limit() {
    }

    @Around("limit() && @annotation(companyIncrLimit)")
    public Object around(ProceedingJoinPoint pjp, CompanyIncrLimit companyIncrLimit) throws Throwable {
        String domainResourceKey = companyIncrLimit.domainResourceKey();
        ...
        if (incrLimiter != null) {
            ...
            incrLimiter.check(
                    ...
                    SPEL_PARSER.parseExpression(companyIncrLimit.incr()).getValue(evaluationContext, Long.class));
        }
        return pjp.proceed();
    }
