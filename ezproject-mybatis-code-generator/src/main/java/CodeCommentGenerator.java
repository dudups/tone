...
public class CodeCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        if (!compilationUnit.getType().getFullyQualifiedName()
    ...
    /**
     * Adds a suitable comment to warn users that the element was generated,
...
//        xmlElement.addElement(new TextElement("<!--"));
        ...
        //        xmlElement.addElement(new TextElement(
        //                "  This element is automatically generated by 
        //                MyBatis "
    ...
    /**
     * This method adds the custom javadoc tag for. You may do nothing if you
     * do not wish to include the Javadoc tag -
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        String authorName = "mybatis-code-generator";
    ...
    public void addClassComment(InnerClass innerClass,
                                IntrospectedTable introspectedTable,
                                boolean markAsDoNotDelete) {
        if (checkSuppressAllComments(suppressAllComments)) {
            return;
        }
    ...
    private boolean checkSuppressAllComments(boolean suppressAllComments) {
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        String authorName = "mybatis-code-generator";
        topLevelClass.addJavaDocLine(" * @Author " + authorName);
    ...
    public void addEnumComment(InnerEnum innerEnum,
        ...
        innerEnum.addJavaDocLine(
                " * This enum was generated by MyBatis Generator."); //$NON
        // -NLS-1$

        sb.append(" * This enum corresponds to the database table "); //$NON
        // -NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
    ...
    public void addFieldComment(Field field,
        ...
        //        if (addRemarkComments && StringUtility.stringHasValue
        //        (remarks)) {
        //            field.addJavaDocLine(" * Database Column Remarks:");
        //            String[] remarkLines =
        //                    remarks.split(System.getProperty("line
        //                    .separator"));
        //            for (String remarkLine : remarkLines) {
...
//        method.addJavaDocLine("/**");
//        method.addJavaDocLine(
//                " * This method was generated by MyBatis Generator."); //$NON
//        // -NLS-1$
//
...
//        StringBuilder sb = new StringBuilder();
    ...
    public void addGeneralMethodAnnotation(Method method,
        ...
        String comment =
                "Source Table: " + introspectedTable.getFullyQualifiedTable()
                        .toString();
    ...
    public void addGeneralMethodAnnotation(Method method,
        ...
        imports.add(new FullyQualifiedJavaType("javax.annotation.Generated"));
        String comment =
                "Source field: " + introspectedTable.getFullyQualifiedTable()
                        .toString() + "."
    ...
    private String getGeneratedAnnotation(String comment) {
        ...
        if (!suppressDate && !suppressAllComments) {
            buffer.append(", date=\"");
            buffer.append(DateTimeFormatter.ISO_OFFSET_DATE_TIME
