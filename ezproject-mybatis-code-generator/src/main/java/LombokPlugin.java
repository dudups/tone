...
public class LombokPlugin extends PluginAdapter {
    ...
    public LombokPlugin() {
        annotations =
                new LinkedHashSet<Annotations>(Annotations.values().length);
    }
     ...
     * @param introspectedTable The class containing information about the
     *                          table as
     ...
     *
     * @param method             the getter, or accessor, method generated
     *                           for the specified
     *                           column
     * @param topLevelClass      the partially implemented model class
     * @param introspectedColumn The class containing information about the
     *                           column related
     *                           to this field as introspected from the database
     * @param introspectedTable  The class containing information about the
     *                           table as
     *                           introspected from the database
     * @param modelClassType     the type of class that the field is
     *                           generated for
     */
    @Override
    ...
    private enum Annotations {
        ...
        NO_ARGS_CONSTRUCTOR("noArgsConstructor", "@NoArgsConstructor",
        ...
        private static Annotations getValueOf(String paramName) {
            for (Annotations annotation : Annotations.values()) {
                if (String.CASE_INSENSITIVE_ORDER
                        .compare(paramName, annotation.paramName) == 0) {
                    return annotation;
                }
            }
        ...
        */
        private static String quote(String value) {
            if (Boolean.TRUE.toString().equals(value) || Boolean.FALSE
        ...
        private void appendOptions(String key, String value) {
            ...
            String valuePart =
                    value.contains(",") ? String.format("{%s}", value) : value;
